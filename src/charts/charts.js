...
export function dibujarCola(eventosActualA, eventosAgregadoA, eventosActualB, eventosAgregadoB, aperturaMin, cierreMin) {
    ...
    if (eventosActualA) {
        datasets.push({
            label: 'Cola A (actual)',
            data: eventosActualA.map(e => ({ x: e.tiempo, y: e.cola })),
            borderColor: '#0070C0',
    ...
    if (eventosAgregadoA && eventosAgregadoA.length) {
        datasets.push({
            label: 'Cola A (agregada)',
            data: eventosAgregadoA,
            borderColor: '#0070C0',
            borderDash: [5, 3],
            backgroundColor: 'transparent',
            borderWidth: 2,
    ...
    if (eventosActualB) {
        datasets.push({
            label: 'Cola B (actual)',
            data: eventosActualB.map(e => ({ x: e.tiempo, y: e.cola })),
            borderColor: '#FFB81C',
            backgroundColor: 'transparent',
            borderWidth: 2,
            stepped: true
    ...
    if (eventosAgregadoB && eventosAgregadoB.length) {
        datasets.push({
            label: 'Cola B (agregada)',
            data: eventosAgregadoB,
            borderColor: '#FFB81C',
            borderDash: [5, 3],
            backgroundColor: 'transparent',
            borderWidth: 2,
...
export function dibujarEsperaMedia(eventosActualA, eventosAgregadoA, eventosActualB, eventosAgregadoB, aperturaMin, cierreMin) {
    ...
    if (eventosActualA) {
        datasets.push({
            label: 'Espera media A (actual)',
            data: calcularPuntosEspera(eventosActualA, aperturaMin, cierreMin),
            borderColor: '#0070C0',
            backgroundColor: 'transparent',
            borderWidth: 2,
            tension: 0.3
    ...
    if (eventosActualB) {
        datasets.push({
            label: 'Espera media B (actual)',
            data: calcularPuntosEspera(eventosActualB, aperturaMin, cierreMin),
            borderColor: '#FFB81C',
            backgroundColor: 'transparent',
            borderWidth: 2,
            tension: 0.3
...
// Función auxiliar para calcular puntos de espera media de una iteración
